...
class Interest(models.Model):
    word = models.ManyToManyField(Word, verbose_name='کلمه', related_name='CustomUser')
    user = models.OneToOneField(CustomUser, on_delete=models.CASCADE, verbose_name='کاربر', related_name='Interest')
